...
# Variables for external VNet
variable "external_vnet_id" {
  description = "The ID of the External VNet."
  type        = string
}

variable "external_vnet_name" {
  description = "The name of the External VNet."
  type        = string
}

variable "external_vnet_rg_name" {
  description = "The resource group name of the External VNet."
  type        = string
}
