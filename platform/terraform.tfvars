...
connectivity_subnets = [
  { name = "management-subnet", address_prefix = "10.0.100.0/24" },
  { name = "nva1-external-subnet", address_prefix = "10.0.1.0/24" },
  { name = "nva1-internal-subnet", address_prefix = "10.0.2.0/24" },
